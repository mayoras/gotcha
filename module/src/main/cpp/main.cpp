...
static GotchaConfig readConfig(const std::string& moduleDir) {
...
static void companion_handler(int i) {
    ...
    GotchaConfig config = readConfig(moduleDir);
    std::string& targetPackageName = config.targetPackageName;
    uint64_t&    delay             = config.delayUs;
